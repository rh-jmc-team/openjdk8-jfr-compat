...
public class TestToolkit {
	...
	public static File materialize(String dir, String file, Class<?> clazz) {
		File matDir;
		try {
	...
	private static File materialize(Class<?> clazz, String directoryName, String fileName) throws IOException {
